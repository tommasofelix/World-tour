...
- Stato del progetto: Fase 2 e Fase 2.5 completate (Vertical Slice V1.0 e Localizzazione/Main Menu collaudati con successo); in preparazione Fase 3 (Ciclo Creativo); stack confermato Godot Engine 4.7.2 win64.
