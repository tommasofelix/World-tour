...
- Stato: `[ ] APERTA`, `[/] IN LAVORAZIONE` oppure `[/] IN VERIFICA`.
- Data di rilevamento: `AAAA-MM-GG`.
- Componente: da indicare.
- Sintomo osservato: da indicare.
- Evidenza: da indicare.
- Causa radice: non determinata finché non verificata.
- Piano collegato: da indicare.
- Criterio di chiusura: da indicare.
